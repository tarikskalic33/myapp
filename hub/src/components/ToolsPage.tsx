  ...
  return (
    <div className="min-h-screen bg-hub-bg text-hub-text">
      ...
      <div className="max-w-4xl mx-auto px-4 pt-16 pb-10 text-center">
        ...
        <p className="text-hub-muted text-base max-w-xl mx-auto mb-6 leading-relaxed">
        ...
        <a
          href="#pricing"
          onClick={() => handlePurchaseClick('tools-hero', 39)}
      ...
      <div className="border-y border-hub-border/60 bg-hub-surface/30">
        <div className="max-w-3xl mx-auto px-4 py-14">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              { step: '01', title: 'Choose your plan',       desc: 'One tool for $19, any two for $29, all three for $39. One payment. No subscription.' },
              { step: '02', title: 'Pay via Lemon Squeezy',  desc: 'Works in 130+ countries — including Bosnia, Serbia, and everywhere Stripe blocks. Card, PayPal.' },
              { step: '03', title: 'Instant access',         desc: 'Redirected back automatically. Click a tool link and it opens. No account, no email, no API key required.' },
            ].map(item => (
